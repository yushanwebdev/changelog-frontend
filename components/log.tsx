  ...
  return (
    <Link href="/abc">
      <div className="flex flex-col items-center text-xl text-center md:flex-row lg:text-2xl logs-list-item text-neutral-400 relative z-[1] md:pl-36 md:gap-6 lg:pl-44 lg:gap-8">
        <div
          className="py-4 relative z-[1] before:content-[''] before:absolute before:z-[1] before:left-1/2 before:w-[1px] before:bg-zinc-800 before:h-full before:top-0 data-[order='1']:before:top-4 data-[order='1']:before:h-[calc(100%-1rem)]"
          data-order="1"
        >
